# Django settings for mixsite project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('Oscar Key', 'oscar@keyfamily.org.uk'),
)
...
SECRET_KEY = 'f!-gfi+r-vk%elsm%sw4=4l6znd%$f733!4s2nha&++t+nzxu9'
...
INSTALLED_APPS = (
    ...
    'mixapp', # the app for the main site
)
